  ...
  return (
    <aside className="sidebar fixed left-0 top-0 z-20 flex h-full w-64 flex-col border-r border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
      <div className="flex h-14 shrink-0 items-center border-b border-zinc-200 px-4 dark:border-zinc-800">
        <Link href="/dashboard" className="font-semibold text-zinc-900 transition-opacity hover:opacity-80 dark:text-zinc-100">
          AISmartCalendar
        </Link>
      </div>
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto p-3">
        ...
        <div className="pt-2">
          <button
            ...
            className="flex w-full items-center justify-between rounded-lg px-3 py-2 text-left text-sm font-medium text-zinc-600 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-800"
          >
